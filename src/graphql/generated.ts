...
export const useCreateFollowTypedDataMutation = <
    ...
    useMutation<CreateFollowTypedDataMutation, TError, CreateFollowTypedDataMutationVariables, TContext>(
      ...
      (variables?: CreateFollowTypedDataMutationVariables) => fetchData<CreateFollowTypedDataMutation, CreateFollowTypedDataMutationVariables>(CreateFollowTypedDataDocument, variables)(),
      options
    );
...
export const useExploreProfilesQuery = <
    ...
    useQuery<ExploreProfilesQuery, TError, TData>(
      variables === undefined ? ['ExploreProfiles'] : ['ExploreProfiles', variables],
      fetchData<ExploreProfilesQuery, ExploreProfilesQueryVariables>(ExploreProfilesDocument, variables),
      options
    );
